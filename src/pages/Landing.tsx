...
const MODULES = [
  ...
  {
    name: 'Приложение (PWA)',
    text: 'Установите SoundLab на компьютер или телефон с сайта. Ярлык на рабочем столе / «Пуск» и отдельное окно — без магазинов приложений.',
  },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Pro даёт 30 облачных проектов, токены для AI-генераций и вокальные пресеты. Platinum — 50 проектов, больше токенов и до 20 сохранений в облако в день. На каждом тарифе проект ограничен 100 МБ. Подробности на /pricing.',
  },
  {
  ...
  {
    q: 'Можно ли установить SoundLab на компьютер или телефон?',
    a: 'Да. SoundLab — это PWA. В Chrome/Edge на Windows или macOS: иконка установки в адресной строке или меню → «Установить приложение» — появится ярлык на рабочем столе и в «Пуск». На iPhone: Safari → Поделиться → «На экран Домой». Магазин приложений не нужен.',
  },
  {
